...
// First block: cos_theta_mu in 1D
  ...
  Block1D* b1t = new Block1D( "mc_p4_mu->CosTheta()",
    "muon cos#theta", "\\cos\\theta_{\\mu}", cos_theta_mu_1D_edges,
    "CC1muXp0pi_MC_Signal && CC1muXp0pi_sig_mc_num_proton_in_momentum_range == 1", kSignalTrueBin );

  Block1D* b1r = new Block1D( "reco_p4mu->CosTheta()",
    "muon cos#theta", "\\cos\\theta_{\\mu}", cos_theta_mu_1D_edges,
    "CC1muXp0pi_Selected && CC1muXp0pi_sel_num_proton_candidates == 1", kOrdinaryRecoBin );
  ...
  title = "leading proton  p_{n}; GeV/c";
  ...
  Block1D *b1dt_delta_pT = new Block1D(branchexpr, title, textitle, pn_1D_edges, selection, kSignalTrueBin);
  ...
  Block1D *b1dr_delta_pT = new Block1D(branchexpr, title, textitle, pn_1D_edges, selection, kOrdinaryRecoBin);
...
//  vect_block.emplace_back(b1dt_sum_theta_mu_p, b1dr_sum_theta_mu_p);
  ...
  background_index = {21, 22, 23, 24, 25, 26};
